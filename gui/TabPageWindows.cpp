...
TabPageWindows::TabPageWindows( window wd,MainFormBase* parentForm )
	:
...
TabPageWindows::~TabPageWindows()
{
}


void TabPageWindows::InitTabPage()
{
	// setup gtc

        m_gtc.Initialize( TABPAGE_WINDOWS_FILEPATH_BASE );
        m_gtc.FetchRequests();
...
void TabPageWindows::UpdateStringsWidgets()
{
	std::string basePath = TABPAGE_WINDOWS_FILEPATH_BASE + GET_CURLANGUAGE_STR + "/";
...
void TabPageWindows::UpdateStringsModalForms()
{
}
